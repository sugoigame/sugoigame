...
<div class="panel-body">
    ...
    <?php if ($padrinho->count()) : ?>
        ...
        <h4>Você foi recrutado por
            <?= $padrinho["nome"] ?>
        </h4>
        <?php if (! $padrinho["bau_ganho"]) : ?>
            <button class="btn btn-success link_send" href="link_Geral/pacote_iniciante.php">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <p>
                                Nível do mais
                                forte:
                                <?= $afilhado["lvl_mais_forte"] ? $afilhado["lvl_mais_forte"] : 0 ?>
                            </p>
                        </div>
                        <div class="col-md-4">
    ...
    <h4>
        Você possui
        <?= $userDetails->conta["medalhas_recrutamento"] ?>
        ...
        <?php foreach ($recompensas as $id => $recompensa) : ?>
            <div class="list-group-item col-md-4">
                ...
                <?php if (isset($recompensa["img"]) && isset($recompensa["skin"])) : ?>
                    ...
                    <div>
                        <img src="Imagens/Personagens/Big/<?= get_img(array("img" => $recompensa["img"], "skin_c" => $recompensa["skin"]), "c") ?>.png"
                            width="100%">
                    </div>
                <?php endif; ?>
                ...
                <p>
                    <button class="btn btn-success link_confirm" href="Geral/recrutamento_comprar.php?rec=<?= $id ?>"
                        data-question="Deseja comprar este item?" <?= $userDetails->conta["medalhas_recrutamento"] >= $recompensa["preco"] ? "" : "disabled" ?>>
                        Comprar
                    </button>
                </p>
            </div>
