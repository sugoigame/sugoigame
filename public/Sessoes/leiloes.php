<div class="panel-heading">
    Centro de comércio
    <?= ajuda_tooltip("O Centro de comércio realiza compra e venda de Ouro entre os jogadores.
    Ao vender moedas e ouro para o centro de comércio, você recebe os Berries pela venda imediatamente.
    O Centro de comércio fará internamente a conversão das Moedas de Ouro por Dobrões de Ouro e os venderá
                    ...
                    <?php while ($oferta = $result->fetch_array()) : ?>
                        <li class="list-group-item">
                            ...
                            <p>
                                ...
                                <?= mascara_berries($oferta["preco_unitario"]) ?>
                            </p>
                            <p>
                                Valor total:
                                <img src="Imagens/Icones/Berries.png" />
                                <?= mascara_berries($oferta["quant"] * $oferta["preco_unitario"]) ?>
                            </p>
                            <p>
                                Data da compra:
