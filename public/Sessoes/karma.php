    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="box-item" style="min-height: 250px">
                ...
                <p>Aumenta em 20% o dano causado pela sua tripulação ao enfrentar qualquer NPC exceto em incursões por
                    24
                    horas</p>
                <p>Preço:
                    <?= PRECO_KARMA_BONUS_1 ?> pontos de Karma Bom
                </p>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="box-item" style="min-height: 250px">
                ...
                <p>Reduz em 20% o dano sofrido pela sua tripulação ao enfrentar qualquer NPC exceto em incursões por 24
                    horas</p>
                <p>Preço:
                    <?= PRECO_KARMA_BONUS_2 ?> pontos de Karma Bom
                </p>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="box-item" style="min-height: 250px">
                ...
                <p>Preço:
                    <?= PRECO_KARMA_BONUS_3 ?> pontos de Karma Bom
                </p>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="box-item" style="min-height: 250px">
                ...
                <p>Preço:
                    <?= PRECO_KARMA_BONUS_4 ?> pontos de Karma Bom
                </p>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="box-item" style="min-height: 250px">
                ...
                <p>Reduz em 15 minutos o tempo de espera para se realizar um novo Mergulho ou Exploração por 24 horas
                </p>
                <p>Preço:
                    <?= PRECO_KARMA_BONUS_5 ?> pontos de Karma Bom
                </p>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="box-item" style="min-height: 290px">
                ...
                <p>Toda vez que saquear um jogador nas próximas 24 horas você receberá 20% dos Berries daquele jogador
                    em
                    vez de 10%</p>
                <p>Preço:
                    <?= PRECO_KARMA_BONUS_1 ?> pontos de Karma Mau
                </p>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="box-item" style="min-height: 290px">
                ...
                <p>Sua perícia ao usar o canhão alcançou um patamar elevado, você consegue fazer mais estragos nos
                    navios
                    atingidos</p>
                <p>Durante 24 horas, seus disparos de canhão causam o dobro do dano nos navios atingidos.</p>
                <p>Preço:
                    <?= PRECO_KARMA_BONUS_4 ?> pontos de Karma Mau
                </p>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="box-item" style="min-height: 290px">
                ...
                <p>Sua experiência de combate permite que você utilize seu Haki com perícia o suficiente para controlar
                    os
                    efeitos das suas Akuma no Mi</p>
                <p>Anula todas as vantagens e desvantagens de todas as suas Akuma no Mi por 24 horas</p>
                <p>Preço:
                    <?= PRECO_KARMA_BONUS_5 ?> pontos de Karma Mau
                </p>
