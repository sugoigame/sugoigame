            ...
            <?php if (count($personagens)) : ?>
                <p>
                    ...
                    <?php if (count($personagens_finalizar)) : ?>
                        <button class="btn btn-success link_send" href='link_Quarto/hospital_finalizar_recuperacao.php'>
                    ...
                    <?php elseif ($pers["respawn_tipo"] == RECUPERACAO_TIPO_QUARTOS) : ?>
                        ...
                        <?php if ($tempo > 0) : ?>
                            ...
                            <button href="Quarto/hospital_cancelar_recuperacao.php?cod=<?= $pers["cod"]; ?>"
                                data-question="Deseja cancelar este tratamento?" class="link_confirm btn btn-danger">
                                Cancelar
                            </button>
                            <button href="Vip/hospital_finalizar.php?cod=<?= $pers["cod"]; ?>"
                                data-question="Deseja finalizar este tratamento agora?" class="link_confirm btn btn-info"
