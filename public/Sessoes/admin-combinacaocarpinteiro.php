...
<div class="panel-body">
    <?php $combinacoes_forja = $connection->run("SELECT * FROM tb_combinacoes_carpinteiro")->fetch_all_array(); ?>
                ...
                <tr>
                    ...
                    <td class="col-md-1">
                        ...
                        <?php elseif (! $combinacao["aleatorio"] && $combinacao["tipo"] == TIPO_ITEM_EQUIPAMENTO) : ?>
                            ...
                            <span class="equipamentos_classe_<?= $equipamentos[$combinacao["cod"]]["categoria"] ?>">
                                <?= $combinacao["cod"] ?> -
                                <?= $equipamentos[$combinacao["cod"]]["nome"] ?>
                                x
                                <?= $combinacao["quant"] ?>
                            </span>
                        <?php elseif ($combinacao["aleatorio"] && $combinacao["tipo"] == TIPO_ITEM_EQUIPAMENTO) : ?>
                            <?php foreach ($resultados as $resultado) : ?>
                                ...
                                <span class="equipamentos_classe_<?= $equipamentos[$resultado["cod"]]["categoria"] ?>">
                                    <?= $resultado["cod"] ?> -
                                    <?= $equipamentos[$resultado["cod"]]["nome"] ?>
                                    x
                                    <?= $resultado["quant"] ?>
                                </span>
                            <?php endforeach; ?>
