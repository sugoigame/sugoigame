    ...
    <?php if ($disputa->count()) : ?>
        ...
        <?php if ($disputa["vencedor_id"]) : ?>
            ...
            <?php if ($disputa["vencedor_id"] == $userDetails->tripulacao["id"]) : ?>
                ...
                <?php else : ?>
                    <button class="btn btn-success link_confirm"
                        data-question="Você irá enfrentar o governante agora! Você está pronto?" href="Ilhas/desafio_pronto.php">
            ...
            <?php if ($userDetails->ilha["ilha_dono"] == $userDetails->tripulacao["id"]) : ?>
                ...
                <?php else : ?>
                    <button class="btn btn-success link_confirm"
                        data-question="Você irá enfrentar seu desafiante agora! Você está pronto?" href="Ilhas/desafio_pronto.php">
                                    ...
                                    <div class="col-md-6">
                                        <h4>
                                            <?php if ($ilha["tripulacao"]) : ?>
                                                <img
                                                    src="Imagens/Bandeiras/img.php?cod=<?= $ilha["bandeira"] ?>&f=<?= $ilha["faccao"] ?>">
                                                <?= $ilha["tripulacao"] ?>
                                            <?php else : ?>
                                                Sem governante
                                            <?php endif; ?>
                    ...
                    <div class="row">
                        <?php foreach ($recompensas as $id => $recompensa) : ?>
                            <div class="list-group-item col-md-4">
                                ...
                                <p>
                                    <button class="btn btn-success link_confirm" <?= $cargas["quant"] >= $recompensa["preco"] ? "" : "disabled" ?> href="Ilhas/cargas_comprar.php?rec=<?= $id ?>"
            ...
            <?php if ($userDetails->ilha["ilha_dono"] == $userDetails->tripulacao["id"]) : ?>
                ...
                <?php if (isset($_GET["tab"]) && $_GET["tab"] == "recursosIlha") : ?>
                    <div class="tab-pane active">
                        ...
                        <form class="form-inline ajax_form" data-question="Deseja gerar estes recursos?" method="post"
                            action="Ilhas/gerar_recurso">
                            <div class="form-group">
                                <label>
                                    Quantidade:
                                </label>
                                <input value="1" type="number" class="form-control" name="quant" min="1"
                                    max="<?= floor($userDetails->tripulacao["berries"] / PRECO_GERAR_RECURSO_ILHA) ?>" required>
                            </div>
                        ...
                        <div class="row list-group">
                            <?php foreach ($bonus_disponiveis as $bonus_id => $bonus) : ?>
                                ...
                                <div class="list-group-item col col-md-4">
                                    ...
                                    <button class="btn btn-success link_confirm" href="Ilhas/ativar_bonus.php?bonus=<?= $bonus_id ?>"
                        ...
                        <form class="form-inline ajax_form" method="post" action="Ilhas/criar_negociacao">
                            <div>
                                <div class="form-group">
                                    ...
                                    <input name="quant" class="form-control" type="number" value="1" min="1" max="500" required>
