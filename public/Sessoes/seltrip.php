...
<div class="panel-body">
    ...
    <div id="sessoes">
                            ...
                            <div class="box-item">
                                <div class="media text-center">
                                    <div class="text-center">
                                        <img src="Imagens/Bandeiras/img.php?cod=<?= $trip["bandeira"]; ?>&f=<?= $trip["faccao"]; ?>"
                                ...
                                <div class="media text-center">
                                    <div class="text-center">
                                        <a href="link_Geral/seltrip.php?trip=<?= $trip["id"] ?>"
                                            class="btn btn-success btn-block link_send">
                                            <i class="fa fa-check"></i>
                                            Selecionar
                                        </a>
                                        <button class="remover-trip btn btn-danger btn-block" data-trip="<?= $trip["id"] ?>"
                                            data-nome="<?= $trip["tripulacao"] ?>" data-hash="<?= substr(md5(time()), 0, 5) ?>">
        ...
        <form action="Geral/criartrip" id="cria-trip-form" method="post" class="ajax_form">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <img src="Imagens/Bandeiras/img.php?cod=010113046758010128123542010115204020&f=0"
                            ...
                            data-placement="bottom" title="Marinheiros são defensores da justiça e da ordem! Eles usam bandeiras e velas
                    ...
                    <div class="col-md-6">
                        <img src="Imagens/Bandeiras/img.php?cod=010113046758010128123542010115204020&f=1"
                            ...
                            data-placement="bottom" title="Piratas são aventureiros seguindo suas próprias leis!
            ...
            <div class="sessao clearfix text-left" id="sessao_3">
                <div class="form-group">
                    ...
                    <input type="text" id="apelido" name="apelido" size="15" maxlength="15" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="capitao" name="capitao" size="15" maxlength="15" class="form-control"
...
<input type="radio" name="oceano" value="0" checked="1"> Aleatório*/ ?>
        ...
        <?php if (count($userDetails->tripulacoes) < 3) : ?>
            <div id="nav-bts">
                <div class="row">
                    <div class="col-xs-6 col-md-6"><button class="btn btn-info noHref btn-block"
                            id="navegador_voltar">&laquo; Voltar</button></div>
                    <div class="col-xs-6 col-md-6"><button class="btn btn-info noHref btn-block"
                            id="navegador_avancar">Criar Tripulação &raquo;</button></div>
                </div>
            </div>
        <?php endif; ?>
    </div>
