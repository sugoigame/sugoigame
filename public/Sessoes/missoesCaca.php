...
<div class="panel-body">
    ...
    <?php if ($userDetails->tripulacao["missao_caca"]) : ?>
        ...
        <p>
            ...
            <?php else : ?>
                <button href="link_MissaoCaca/missao_caca_finalizar.php" class="link_send btn btn-success">
                    Finalizar
                </button>
            <?php endif; ?>
        </p>
                            ...
                            <?php if (isset($missao["diario"]) && $missao["diario"]) : ?>
                                ...
                                <?php if (! $completa) : ?>
                                    <button href="MissaoCaca/missao_caca_iniciar.php?cod=<?= $id ?>"
                                        data-question="Deseja iniciar essa missão?" class="link_confirm btn btn-success">
                                        Iniciar
                                    </button>
                                <?php else : ?>
