...
function render_status_akuma($pers, $img_akuma, $tipoakuma)
{
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-left">
            ...
            <ul>
                <li><span id="quantidade_ataques">
                        <?= ($tipoakuma == 10) ? "2" : "3" ?>
                    </span> Ataques</li>
                <li><span id="quantidade_buffs">
                        <?= ($tipoakuma == 10) ? "5" : ($tipoakuma == 9 ? "4" : "3") ?>
                    </span>
                    Buffs
                </li>
                <li><span id="quantidade_passivas">
                        <?= ($tipoakuma == 8) ? "5" : "4" ?>
                    </span> Passivas</li>
            </ul>
        </div>
...
{ ?>
    ...
    <div class="form-group">
        <label>Nome:</label>
        <input <?= $nome_akuma ? "readonly" : "" ?> value="<?= $nome_akuma ? $nome_akuma : $sugestao_nome["nome"] ?>"
    ...
    <ul class="list-group text-center">
        ...
        <?php for ($x = 0; $x < 51; $x += 5) : ?>
            <li class="list-group-item">
                ...
                <!-- tipo -->
                <div id="form_radios">
                    <label class="checkbox-inline radio_atk_<?php if ($x == 0)
                        echo 1;
                    else
                        echo $x; ?>">
                        <input onclick="sel_atk('<?php if ($x == 0)
                            echo 1;
                        else
                            echo $x; ?>');" type="radio" name="tipo_skil_<?php if ($x == 0)
                                  echo 1;
                              else
                                  echo $x; ?>" value="0" />
                        <span>Ataque</span>
                    </label>
                    <label class="checkbox-inline radio_buf_<?php if ($x == 0)
                        echo 1;
                    else
                        echo $x; ?>">
                        <input onclick="sel_buf('<?php if ($x == 0)
                            echo 1;
                        else
                            echo $x; ?>');" type="radio" name="tipo_skil_<?php if ($x == 0)
                                  echo 1;
                    ...
                    <label class="checkbox-inline radio_pas_<?php if ($x == 0)
                        echo 1;
                    else
                        echo $x; ?>">
                        <input onclick="sel_pas('<?php if ($x == 0)
                            echo 1;
                        else
                            echo $x; ?>');" type="radio" name="tipo_skil_<?php if ($x == 0)
                                  echo 1;
                ...
                <div id="skill-details-<?php if ($x == 0)
                    echo 1;
                else
                    echo $x; ?>" class="skill-details">
                    <div class="form-inline">
                        <!-- bonus -->
                        <div id="select_atributo_<?php if ($x == 0)
                            echo 1;
                        else
                            echo $x; ?>" class="form-group">
                            <select class="form-control" name="atr_skil_<?php if ($x == 0)
                                echo 1;
                            else
                                echo $x; ?>" size="1">
                        ...
                        <!-- bonus value -->
                        <div id="add_sb_<?php if ($x == 0)
                            echo 1;
                        else
                            echo $x; ?>" class="form-group">
                            <select name="add_ou_sub_<?php if ($x == 0)
                                echo 1;
                            else
                                echo $x; ?>" id="add_ou_sub_<?php if ($x == 0)
                                      echo 1;
                                  else
                                      echo $x; ?>" class="form-control" style="display: none;">
                                <option value="1">+</option>
                                <option value="-1">-</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <input class="form-control input-text" name="bonus_value_<?php if ($x == 0)
                                echo 1;
                            else
                                echo $x; ?>" id="bonus_value_<?php if ($x == 0)
                                      echo 1;
                                  else
                                      echo $x; ?>" readonly="true" size="1">
                        </div>
                    </div>
                    <div class="form-inline">
                        <!-- energia gasta -->
                        <div class="form-group">
                            ...
                            <input name="energia_<?php if ($x == 0)
                                echo 1;
                            else
                                echo $x; ?>" id="energia_<?php if ($x == 0)
                                      echo 1;
                                  else
                                      echo $x; ?>" class="form-control input-text" readonly="true" size="1" />
                        </div>
                    </div>
                    <div class="form-inline">
                        <!-- alcance -->
                        <div class="form-group">
                            <label>Alcance:</label>
                            <select id="alcance_<?php if ($x == 0)
                                echo 1;
                            else
                                echo $x; ?>" name="alcance_<?php if ($x == 0)
                                      echo 1;
                                  else
                                      echo $x; ?>" class="form-control" onchange="atualizaBonus('1',this.value,'<?php if ($x == 0)
                                            echo 1;
                                        else
                                            echo $x; ?>')">
                    ...
                    <div class="form-inline">
                        ...
                        <div class="form-group">
                            ...
                            <select id="area_<?php if ($x == 0)
                                echo 1;
                            else
                                echo $x; ?>" name="area_<?php if ($x == 0)
                                      echo 1;
                                  else
                                      echo $x; ?>" class="form-control" onchange="atualizaBonus('2',this.value,'<?php if ($x == 0)
                                            echo 1;
                                        else
                                            echo $x; ?>')">
                                <option value="1">1 quadro</option>
                    ...
                    <div class="form-inline">
                        ...
                        <div class="form-group">
                            ...
                            <input name="duracao_<?php if ($x == 0)
                                echo 1;
                            else
                                echo $x; ?>" id="duracao_<?php if ($x == 0)
                                      echo 1;
                                  else
                                      echo $x; ?>" class="form-control input-text" readonly="true" size="1" />
                        </div>
                    ...
                    <div class="form-inline">
                        ...
                        <div class="form-group">
                            <label>Espera:</label>
                            <input name="cooldown_<?php if ($x == 0)
                                echo 1;
                            else
                                echo $x; ?>" id="cooldown_<?php if ($x == 0)
                                      echo 1;
                                  else
                                      echo $x; ?>" class="form-control input-text" readonly="true" size="1" value="<?php if ($x < 11)
                                            echo "1";
                                        elseif ($x > 11 and $x < 21)
                                            echo "2";
                                        elseif ($x > 21 and $x < 31)
                                            echo "3";
