...
<div class="row">
    ...
    <div class="col-md-4 col-xs-12">
        ...
        <p>
            <button class="btn btn-info link_send" href="link_Personagem/change_sex.php?pers=<?= $pers["cod"] ?>">
                Usar alcunha
                <?= $pers["sexo"] == 0 ? "Feminina" : "Masculina"; ?>
            </button>
        </p>
...
<?php if ($userDetails->tripulacao["credito_skin"]) : ?>
    <h4>Você tem direito à
        <?= $userDetails->tripulacao["credito_skin"] ?> Aparência(s) Gratuita(s)
    </h4>
<?php endif; ?>
<div class="row">
