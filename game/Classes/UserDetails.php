...
class UserDetails {
    ...
    private function _update_mini_eventos() {
        ...
        foreach ($events as $event) {
            ...
            $this->connection->run("DELETE FROM tb_mini_eventos_concluidos WHERE mini_evento_id = ?",
                "i", array($event["id"]));
        }
    ...
    public function set_authentication($conta_id) {
        ...
        $this->connection->run("UPDATE tb_conta SET cookie = ? WHERE conta_id = ?",
            "si", array($cookie, $conta_id));
    }
