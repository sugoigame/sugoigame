...
class CombateLogger {
    ...
    public function get_relatorio_combate_pvp($combate) {
        $log_file = @fopen(dirname(__FILE__) . "/../../logs/combate-pvp-" . $combate . ".log", "r");
    ...
    public function registra_turno_combate_pvp($relatorio) {
        $log_file = fopen(dirname(__FILE__) . "/../../logs/combate-pvp-" . $this->userDetails->combate_pvp["combate"] . ".log", "a+");
