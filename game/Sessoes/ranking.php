...
<div class="panel-body">
    ...
    <p>
        <a href="?ses=era" class="link_content btn btn-info">
            Ver recompensas pela Grande Era dos Piratas
        </a>
    </p>
    <p>
        <a href="?ses=batalhaPoderes" class="link_content btn btn-info">
    ...
    <div>
        <ul class="nav nav-pills nav-justified">
            <li class="<?= $ranking == "reputacao" ? "active" : "" ?>">
                <a href="?ses=ranking&rank=reputacao" class="link_content">Grande Era dos Piratas</a>
            </li>
            <li class="<?= $ranking == "reputacao_mensal" ? "active" : "" ?>">
                <a href="?ses=ranking&rank=reputacao_mensal" class="link_content">Batalha pelos Grandes Poderes</a>
            </li>
                ...
                <?php for ($i = $page - 3; $i <= $page + 3 && $i < floor($total / 25); $i++): ?>
                    <?php if ($i >= 0): ?>
                        <li class="<?= $i == $page ? "active" : "" ?>">
                            <a href="?ses=ranking&rank=<?= $ranking ?>&faccao=<?= $faccao ?>&page=<?= $i ?>"
                               class="link_content">
