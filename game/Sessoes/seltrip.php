    ...
    <div id="sessoes">
        <div class="sessao" id="sessao_1">
            <?php if (count($userDetails->tripulacoes)): ?>
                <p>Selecione sua tripulação e começar a navegar!</p>
                <ul class="list-group">
                    <?php foreach ($userDetails->tripulacoes as $trip): ?>
                        <li class="list-group-item">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <a href="Scripts/Geral/seltrip.php?trip=<?= $trip["id"] ?>"
                                       class="btn btn-success link_redirect">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <button class="remover-trip btn btn-danger"
                                            data-trip="<?= $trip["id"] ?>"
        ...
        <form action="Scripts/Geral/criartrip.php" id="cria-trip-form" method="post">
            ...
            <div class="sessao clearfix" id="sessao_4">
                ...
                <input type="radio" name="oceano" value="3"> South Blue<br>
        ...
        <?php if (count($userDetails->tripulacoes) < 3): ?>
            <div id="nav-bts">
                <button class="btn btn-info noHref" id="navegador_voltar">&laquo; Voltar</button>
                ||
                <button class="btn btn-info noHref" id="navegador_avancar">Criar Tripulação &raquo;</button>
            </div>
        <?php endif; ?>
    </div>
</div>