...
$time = time() - strtotime("2017-12-11 00:00:00");
...
if ($treinos_limite < $quant || $quant > 6) {
    $protector->exit_error('Quantidade de treinos inválida');
}

$preco_unitario = $quant > $treinos_possiveis ? 2000000 : 1000000;

$preco = $quant * $preco_unitario + ($quant - 1) * $preco_unitario;
