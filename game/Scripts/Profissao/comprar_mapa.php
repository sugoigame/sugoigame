...
if (!$mapa AND $cont < $usuario["capacidade_iventario"]) {
    ...
    mysql_query($query) or die("nao foi possivel comprar o mapa");

    $query = "INSERT INTO tb_item_mapa (id) VALUES ('" . $usuario["id"] . "')";
    mysql_query($query) or die("nao foi possivel criar o mapa");
    ...
    mysql_query($query) or die("nao foi possivel guardar o mapa");
