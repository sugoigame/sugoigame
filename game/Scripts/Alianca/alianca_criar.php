...
if ($inally) {
    mysql_close();
    header("location:../../index.php?msg=Você ja faz parte de uma aliança/frota");
    exit();
}
...
if (strlen($nome) < 5) {
    mysql_close();
    header("location:../../index.php?msg=Esse nome é muito curto.");
    exit();
}
...
if (mysql_num_rows($result) != 0) {
    mysql_close();
    header("location:../../index.php?msg=Esse nome não está disponivel.");
    exit();
}
...
switch ($forma) {
    case 1:
        ...
        if ($preco <= 0) {
            header("location:../../index.php?msg=Você não tem berries o suficiente.");
            exit();
        }
    ...
    case 2:
        ...
        if ($preco <= 0) {
            header("location:../../index.php?msg=Você não tem ouro o suficiente.");
            exit();
        }
        ...
        break;
    default:
        header("location:../../index.php?msg=Opção errada");
        exit();
        break;
}
...
mysql_close();
header("location:../../index.php?ses=alianca");
?>