<?php
	...
	if($permicao["autoridade"]==0){
		mysql_close();
		header("location:../../index.php?msg=Você não pode sair da sua aliança.");
		exit();
	}
	...
	if(mysql_num_rows($result)!=0){
		mysql_close();
		header("location:../../index.php?msg=Você está em guerra!");
		exit();
	}
	...
	mysql_close();
	header("location:../../index.php?ses=aliancaCriar");
?>