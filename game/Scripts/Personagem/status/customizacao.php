        ...
        <div class="list-group-item col-md-3">
            ...
            <?php if ($tem_skin): ?>
                <p class="text-success">
                    Borda disponível. <i class="fa fa-check"></i>
                </p>
                <p>
                    Clique na foto para ativar
                </p>
            <?php elseif ($borda["preco"] > 0): ?>
                <button class="btn btn-info link_confirm"
                        data-question="Deseja adquirir essa borda para sua tripulação?"
